...
using Mvc3HomeBrewShed.Controllers;
using viewModels = Mvc3HomeBrewShed.Areas.SecurityGuard.ViewModels;

namespace Mvc3HomeBrewShed.Areas.SecurityGuard.Controllers
{
